...
import { Modal, getTheme, mergeStyleSets, FontWeights, DefaultButton, Checkbox, ContextualMenu } from 'office-ui-fabric-react';
...
var ModalModelessExample = /** @class */ (function (_super) {
    ...
    ModalModelessExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(Checkbox, { label: "Is draggable", onChange: this._toggleDraggable, checked: isDraggable, disabled: showModal }),
            React.createElement(DefaultButton, { secondaryText: "Opens the Sample Modal", onClick: this._showModal, text: "Open Modal" }),
            React.createElement(Modal, { titleAriaId: this._titleId, subtitleAriaId: this._subtitleId, isOpen: showModal, onDismiss: this._closeModal, isModeless: true, containerClassName: styles.container, dragOptions: isDraggable ? this._dragOptions : undefined },
