...
import { getTheme, mergeStyleSets, FontWeights, ContextualMenu, Checkbox, DefaultButton, Modal } from 'office-ui-fabric-react';
...
var ModalBasicExample = /** @class */ (function (_super) {
    ...
    ModalBasicExample.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(Checkbox, { label: "Is draggable", onChange: this._toggleDraggable, checked: this.state.isDraggable }),
            React.createElement(DefaultButton, { secondaryText: "Opens the Sample Modal", onClick: this._showModal, text: "Open Modal" }),
            React.createElement(Modal, { titleAriaId: this._titleId, subtitleAriaId: this._subtitleId, isOpen: this.state.showModal, onDismiss: this._closeModal, isBlocking: false, containerClassName: styles.container, dragOptions: this.state.isDraggable ? this._dragOptions : undefined },
