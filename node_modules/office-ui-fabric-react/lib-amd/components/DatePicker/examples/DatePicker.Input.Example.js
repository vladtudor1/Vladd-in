define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/DatePicker", "office-ui-fabric-react/lib/Styling"], function (require, exports, tslib_1, React, Button_1, DatePicker_1, Styling_1) {
    "use strict";
    ...
    var DatePickerInputExample = /** @class */ (function (_super) {
        ...
        DatePickerInputExample.prototype.render = function () {
            ...
            return (React.createElement("div", { className: "docs-DatePickerExample" },
                ...
                React.createElement(DatePicker_1.DatePicker, { className: controlClass.control, label: "Start date", isRequired: false, allowTextInput: true, ariaLabel: desc, firstDayOfWeek: firstDayOfWeek, strings: DayPickerStrings, value: value, onSelectDate: this._onSelectDate }),
