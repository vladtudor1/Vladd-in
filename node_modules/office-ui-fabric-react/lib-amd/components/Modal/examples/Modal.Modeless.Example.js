define(["require", "exports", "tslib", "react", "office-ui-fabric-react", "office-ui-fabric-react/lib/Utilities"], function (require, exports, tslib_1, React, office_ui_fabric_react_1, Utilities_1) {
    "use strict";
    ...
    var ModalModelessExample = /** @class */ (function (_super) {
        ...
        ModalModelessExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                React.createElement(office_ui_fabric_react_1.Checkbox, { label: "Is draggable", onChange: this._toggleDraggable, checked: isDraggable, disabled: showModal }),
                ...
                React.createElement(office_ui_fabric_react_1.Modal, { titleAriaId: this._titleId, subtitleAriaId: this._subtitleId, isOpen: showModal, onDismiss: this._closeModal, isModeless: true, containerClassName: styles.container, dragOptions: isDraggable ? this._dragOptions : undefined },
                    ...
                    React.createElement("div", { id: this._subtitleId, className: styles.body },
                        React.createElement(office_ui_fabric_react_1.DefaultButton, { onClick: this._closeModal, text: "Close" }),
