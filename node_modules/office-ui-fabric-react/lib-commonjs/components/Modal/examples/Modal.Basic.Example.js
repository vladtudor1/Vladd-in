...
var ModalBasicExample = /** @class */ (function (_super) {
    ...
    ModalBasicExample.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(office_ui_fabric_react_1.Checkbox, { label: "Is draggable", onChange: this._toggleDraggable, checked: this.state.isDraggable }),
            ...
            React.createElement(office_ui_fabric_react_1.Modal, { titleAriaId: this._titleId, subtitleAriaId: this._subtitleId, isOpen: this.state.showModal, onDismiss: this._closeModal, isBlocking: false, containerClassName: styles.container, dragOptions: this.state.isDraggable ? this._dragOptions : undefined },
