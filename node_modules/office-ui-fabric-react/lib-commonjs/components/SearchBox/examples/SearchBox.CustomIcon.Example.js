...
var SearchBoxCustomIconExample = /** @class */ (function (_super) {
    ...
    SearchBoxCustomIconExample.prototype.render = function () {
        return (React.createElement(SearchBox_1.SearchBox, { placeholder: "Filter", onFocus: function () { return console.log('onFocus called'); }, onBlur: function () { return console.log('onBlur called'); }, iconProps: { iconName: 'Filter' } }));
    };
